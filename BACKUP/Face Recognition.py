...
def deregister():
    ...
    root1.title("Delete")
    image2 = PhotoImage(file=r"/Attendance Automation Using Facial Recognition/icons and background/remove.png")
...
# GUI Initialization
imag = tk.PhotoImage(
    file=r"/Attendance Automation Using Facial Recognition/icons and background/wp8047222-blue-tech-wallpapers.png")
